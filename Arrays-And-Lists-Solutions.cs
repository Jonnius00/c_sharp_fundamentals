...
/// </summary>
        public void Exercise4()
        {
            ...
            foreach (var number in uniques) Console.WriteLine(number);
        }
...
/// </summary>
        public void Exercise5()
        {
            ...
            {
            // Assume the first number in input is the smallest
                var min = numbers[0];
                foreach (var number in numbers)
            ...
            foreach (var number in smallests) Console.WriteLine(number);
        }
    }
}